...
%does multitaper deconvolution. Out of fairness, I should note here I was
%given some code by Catherine Rychert, but I had to code everything up
%myself to get it work. I wrote this, but a couple lines probably look like
%the code she gave me (I think the title is same for some reason too). Joseph Byrnes.
