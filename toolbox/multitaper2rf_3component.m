function [ trace_p, trace_sv, trace_sh ] = multitaper2rf_3component( P_comp, SV_comp, SH_comp, dt, rf_shift, ntap, NW, nmtw, phase, filter_limits, taper_ind )
...
%byrnes.joseph@gmail.com
    ...
    elseif strcmp(phase, 'SV') || strcmp(phase, 'S')
        ...
        amp = max(trace_sv(norm_window(1):norm_window(2)));
